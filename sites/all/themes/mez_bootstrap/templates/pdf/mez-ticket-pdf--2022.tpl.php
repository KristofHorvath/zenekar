...
\includegraphics[width=2.75cm]{<?php print drupal_realpath(drupal_get_path('theme', 'mez_bootstrap') . '/images') . '/';?>mez_logo_2019.png}\\
...
\node[anchor=north, align=center] at (13,6.9) {
	...
	2022. december 2. péntek 19:30\vspace{3mm}\\
...
<?php foreach ($tickets as $ticket) :?>
 \mezticket{<?php print ucfirst($ticket['seat']) ?>}{<?php print $ticket['price']?> Ft}{<?php print str_pad($ticket['id'], 8, '0', STR_PAD_LEFT); ?>}{<?php print format_date($order->created, 'short', '', NULL, 'hu');?>}
<?php endforeach;?>
